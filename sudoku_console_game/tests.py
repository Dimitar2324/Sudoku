...
class TestSudokuValidator(unittest.TestCase):
    def test_for_invalid_addition_in_row(self):
        ...
        result = SudokuValidator.is_valid((0, 2), 7, sudoku)
    ...
    def test_for_invalid_addition_in_col(self):
        ...
        result = SudokuValidator.is_valid((2, 0), 7, sudoku)
        self.assertEqual(result, False)
    ...
    def test_for_invalid_addition_in_3x3_box(self):
        ...
        result = SudokuValidator.is_valid((0, 2), 8, sudoku)
        self.assertEqual(result, False)
    ...
    def test_for_valid_move(self):
        ...
        result = SudokuValidator.is_valid((2, 0), 1, sudoku)
...
class TestSudokuGenerator(unittest.TestCase):
    ...
    def test_for_generating_easy_sudoku_from_right_file(self):
        ...
        sudoku = ''.join([str(i) for i in (numpy.array(SudokuGenerator.generate_from_personals('easy')) .flatten())])
    ...
    def test_for_generating_medium_sudoku_from_right_file(self):
        ...
        sudoku = ''.join([str(i) for i in (numpy.array(SudokuGenerator.generate_from_personals('medium')) .flatten())])
    ...
    def test_for_generating_hard_sudoku_from_right_file(self):
        ...
        sudoku = ''.join([str(i) for i in (numpy.array(SudokuGenerator.generate_from_personals('hard')) .flatten())])
    ...
    def test_for_generating_random_easy_sudoku(self):
        sudoku = SudokuGenerator.generate_random('easy')
    ...
    def test_for_generating_random_medium_sudoku(self):
        sudoku = SudokuGenerator.generate_random('medium')
        number_of_zeroes = sum([row.count(0) for row in sudoku])
    ...
    def test_for_generating_random_hard_sudoku(self):
        sudoku = SudokuGenerator.generate_random('hard')
        number_of_zeroes = sum([row.count(0) for row in sudoku])
...
class TestInputValidator(unittest.TestCase):
    ...
    def test_for_is_invalid_pos_must_throw_pos_out_of_range_exception(self):
        ...
        self.assertRaises(exceptions.PositionOutOfRangeException, InputValidator.is_invalid_pos, (9, 1), 0, 9)
        self.assertRaises(exceptions.PositionOutOfRangeException, InputValidator.is_invalid_pos, (3, -1), 0, 9)
        self.assertRaises(exceptions.PositionOutOfRangeException, InputValidator.is_invalid_pos, (-2, -1), 0, 9)

    def test_for_check_hints_available_must_throw_no_more_hints_exception(self):

        self.assertRaises(exceptions.NoMoreHintsException, InputValidator.check_hints_available, 0)
        self.assertRaises(exceptions.NoMoreHintsException, InputValidator.check_hints_available, -1)

    def test_for_is_invalid_num_must_throw_num_out_of_range_exception(self):
        self.assertRaises(exceptions.NumberOutOfRangeException, InputValidator.is_invalid_num, 10, 1, 9)
        self.assertRaises(exceptions.NumberOutOfRangeException, InputValidator.is_invalid_num, 0, 1, 9)

    def test_for_invalid_confirmation_answer(self):
        self.assertRaises(exceptions.NotAllowedConfirmationAnswerException, InputValidator.is_invalid_confirmation, '')
        self.assertRaises(exceptions.NotAllowedConfirmationAnswerException, InputValidator.is_invalid_confirmation, 'shd')
        self.assertRaises(exceptions.NotAllowedConfirmationAnswerException, InputValidator.is_invalid_confirmation, ' ')
    ...
    def test_for_is_filled_pos_must_throw_already_filled_cell_exception(self):
        ...
        self.assertRaises(exceptions.FilledCellException, InputValidator.is_filled_pos, sudoku, (0, 0))

    def test_for_is_invalid_input_type_must_throw_invalid_input_type_exception(self):
        self.assertRaises(exceptions.WrongInputTypeException, InputValidator.is_invalid_input_type, '')
        self.assertRaises(exceptions.WrongInputTypeException, InputValidator.is_invalid_input_type, 'sadf')

    def test_for_is_invalid_tuple(self):
        self.assertRaises(exceptions.InvalidTupleException, InputValidator.is_invalid_tuple, ['4'])
        self.assertRaises(exceptions.InvalidTupleException, InputValidator.is_invalid_tuple, [])

    def test_for_invalid_tuple_arguments(self):
        self.assertRaises(exceptions.InvalidTupleArgsException, InputValidator.check_arguments_of_tuple, ['ere', 'ds'])
